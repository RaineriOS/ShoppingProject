...
+ (void)load
{
    ...
    fprintf( stderr, "****************************************************************************************\n" );
    fprintf( stderr, "    											   \n" );
    fprintf( stderr, "    	copyright (c) 2015, {suning}               \n" );
    fprintf( stderr, "    										       \n" );
...
//           [DDLog addLogger:fileLogger];
        ...
        if (xcode_colors && (strcmp(xcode_colors, "YES") == 0))
        {
            ...
            [[DDTTYLogger sharedInstance] setForegroundColor:YNRGB(0, 0, 255)
                                             backgroundColor:nil
                                                     forFlag:LOG_FLAG_INFO];
            [[DDTTYLogger sharedInstance] setForegroundColor:YNRGB(255, 255, 255)
                                             backgroundColor:nil
